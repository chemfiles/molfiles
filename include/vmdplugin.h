...
#define VMDPLUGIN_xcat(x, y) VMDPLUGIN_cat(x, y)
/** concatenation macro, joins args x and y together as a single string */
#define VMDPLUGIN_cat(x, y) x ## y
...
#define VMDPLUGIN_register     VMDPLUGIN_xcat(VMDPLUGIN, _register)
#define VMDPLUGIN_register_tcl VMDPLUGIN_xcat(VMDPLUGIN, _register_tcl)
#define VMDPLUGIN_init         VMDPLUGIN_xcat(VMDPLUGIN, _init)
#define VMDPLUGIN_fini         VMDPLUGIN_xcat(VMDPLUGIN, _fini)
/*@}*/
